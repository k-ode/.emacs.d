(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (indium graphql-mode clj-refactor cider dashboard fsharp-mode rjsx-mode helm-descbinds neotree projectile helm js2-mode company doom-themes helm-flycheck tide whitespace-cleanup-mode spaceline jade csharp-mode which-key wgrep use-package undo-tree tagedit smooth-scrolling smartparens scss-mode restclient rainbow-mode pt move-text material-theme markdown-mode magit less-css-mode json-mode js2-refactor ignoramus idomenu ibuffer-vc hydra highlight-symbol helm-swoop helm-projectile helm-css-scss helm-ag flycheck f expand-region css-eldoc company-tern anzu ace-window)))
