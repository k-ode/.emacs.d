(add-to-list 'load-path "~/../../utils/Emacs/site-lisp/slime")
(require 'slime)
(require 'slime-js)
(slime-setup)
...
(defun slime-js-jack-in-node ()
  ...
  (setq slime-js-jacked-in-p t)
  (slime-connect "localhost" 4005))

(defun slime-js-jack-in-browser ()
  "Start a swank-js server, connect to it, open a repl, open a browser"
  (interactive)
...
(defadvice save-buffer (after save-css-buffer activate)
  (when (and slime-js-jacked-in-p (eq major-mode 'css-mode))
